...
- **Two wake words, two agents (2026-08-03 — see the agent-split ADR):**
  ...
  - **"Kenobi"** (renamed from "Hey Jarvis" 2026-09-04) → pipeline **Living Room Knowledge** → `conversation.openai_conversation_2` (gpt-4o)
